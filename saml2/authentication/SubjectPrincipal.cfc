...
component
  ...
  displayname="Class SubjectPrincipal"
  output="false"
{
  public cfboom.security.saml.saml2.authentication.SubjectPrincipal function init() {
    return this;
  }
  ...
  public cfboom.security.saml.saml2.authentication.SubjectPrincipal function setValue(string value) {
