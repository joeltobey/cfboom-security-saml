...
component
  ...
  displayname="Class ServiceProviderMetadata"
  output="false"
{
  public cfboom.security.saml.saml2.metadata.ServiceProviderMetadata function init(cfboom.security.saml.saml2.metadata.EntityDescriptor other) {
    super.init( argumentCollection = arguments );
    return this;
  }

  public any function getServiceProvider() {
